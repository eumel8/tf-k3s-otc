...
rancher_version   = <rancher version>     # e.g. "v2.7.2"
rancher_tag       = <rancher image tag>   # e.g. "v2.7.2"
admin_email       = <admin email address for DNS/LetsEncrypt> # e.g. "nobody@telekom.de"
k3s_version       = <k3s version> # e.g. channel stable/latest or version "v1.25.9+k3s1"
access_key        = <otc access key>
secret_key        = <otc secret key>
